...
/**
 * Published when a department head has been assigned to a department.
 *
 ...
 * @param departmentHeadUsername unique username of the assigned department head (OIDC subject)
 */
public record DepartmentHeadAssignedEventDTO(
    UUID id, Long sourceId, Instant createdAt, String tenantId, String departmentHeadUsername) {

  public static DepartmentHeadAssignedEventDTO create(
  ...
  public static DepartmentHeadAssignedEventDTO create(
    ...
    return new DepartmentHeadAssignedEventDTO(
